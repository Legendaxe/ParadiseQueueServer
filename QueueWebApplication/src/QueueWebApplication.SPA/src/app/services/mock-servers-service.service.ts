...
export class MockServersServiceService {
  ...
  connect() {
    let servers: Server[];
    servers = [
      { name: "Green", maximumPlayers:-1, whitelisted:false, port:4002, ipAddress:"s1.ss220.club", currentPlayers:20, queuePosition:20},
      { name: "Black", maximumPlayers:100, whitelisted:false, port:4000, ipAddress:"s1.ss220.club", currentPlayers:100, queuePosition:20},
      { name: "Prime", maximumPlayers:-1, whitelisted:true, port:4001, ipAddress:"s1.ss220.club", currentPlayers:20, queuePosition:20},
      { name: "TG", maximumPlayers:-1, whitelisted:true, port:4002, ipAddress:"s1.ss220.club", currentPlayers:20, queuePosition:20},
    ];
